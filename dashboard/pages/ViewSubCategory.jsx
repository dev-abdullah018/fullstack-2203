...
const ViewSubCategory = () => {
    ...
    const onFinish = async (values) => {
      ...
      let data =  await axios.post("http://localhost:8000/api/v1/product/editsubcat",{
        ...
        async function allsubcat(){
            ...
            data.data.map(item =>{
                catdata.push({
                    ...
                    name: item.name,
                    status: item.status,
                    categoryId: item.categoryId ? item.categoryId.name : 'Unknown'
                })
    ...
    let handleClick = async (record) => {
      ...
      let response = await axios.post("http://localhost:8000/api/v1/product/approvesubcategory",{
        id: record.key,
